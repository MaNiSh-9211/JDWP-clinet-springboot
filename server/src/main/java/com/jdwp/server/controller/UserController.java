...
public class UserController {
    ...
    public ResponseEntity<List<User>> getAllUsers() {
        ...
        logger.info("========================================");
        logger.info("[CONTROL ENTERED] UserController.getAllUsers() - Line 19");
        // BREAKPOINT: Set breakpoint here (line 19) to debug getAllUsers
        int a = 20;
    ...
    public ResponseEntity<User> getUserById(@PathVariable Long id) {
        ...
        logger.info("========================================");
        logger.info("[CONTROL ENTERED] UserController.getUserById() - Line 26");
        logger.info("[DEBUG] Parameter id = {}", id);
        
        // BREAKPOINT: Set breakpoint here (line 25) to debug getUserById
    ...
    public ResponseEntity<User> createUser(@RequestBody User user) {
        ...
        logger.info("========================================");
        logger.info("[CONTROL ENTERED] UserController.createUser() - Line 36");
        ...
        // BREAKPOINT: Set breakpoint here (line 34) to debug createUser
    ...
    public ResponseEntity<User> updateUser(@PathVariable Long id, @RequestBody User user) {
        ...
        logger.info("========================================");
        logger.info("[CONTROL ENTERED] UserController.updateUser() - Line 43");
        logger.info("[DEBUG] Parameter id = {}", id);
        logger.info("[DEBUG] Request body user = {}", user);
        logger.info("[DEBUG] User details - Name: {}, Email: {}, Age: {}", 
                   user != null ? user.getName() : "null",
        ...
        // BREAKPOINT: Set breakpoint here (line 41) to debug updateUser
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable Long id) {
        ...
        logger.info("========================================");
        logger.info("[CONTROL ENTERED] UserController.deleteUser() - Line 53");
        logger.info("[DEBUG] Parameter id = {}", id);
        
        // BREAKPOINT: Set breakpoint here (line 51) to debug deleteUser
